...
{	
	...
	private static $errors = array(
		...
		'textInSwitch' => "Обнаружен текстовый элемент непосредственно внутри оператора <b>switch</b> в шаблоне {??} класса {??}<br><br>Обнаруженный текст: <xmp>{?}</xmp>Ожидается один из операторов:<xmp>case\ndefault</xmp>",
		'elementInSwitch' => "Обнаружен элемент DOM непосредственно внутри оператора <b>switch</b> в шаблоне {??} класса {??}<br><br>Обнаруженный элемент: <xmp>{?}</xmp>Код в котором произошла ошибка: <xmp>{?}</xmp>Ожидается один из операторов:<xmp>case\ndefault</xmp>",
		'componentInSwitch' => "Обнаружен компонент непосредственно внутри оператора <b>switch</b> в шаблоне {??} класса {??}<br><br>Обнаруженный компонент: <xmp>{?}</xmp>Код в котором произошла ошибка: <xmp>{?}</xmp>Ожидается один из операторов:<xmp>case\ndefault</xmp>",
		'operatorInSwitch' => "Обнаружен недопустимый оператор непосредственно внутри оператора <b>switch</b> в шаблоне {??} класса {??}<br><br>Обнаруженный оператор: <xmp>{?}</xmp>Код в котором произошла ошибка: <xmp>{?}</xmp>Ожидается один из операторов:<xmp>case\ndefault</xmp>",
		'templateInSwitch' => "Обнаружен вызов шаблона непосредственно внутри оператора <b>switch</b> в шаблоне {??} класса {??}<br><br>Обнаруженный вызов шаблона: <xmp>{?}</xmp>Код в котором произошла ошибка: <xmp>{?}</xmp>Ожидается один из операторов:<xmp>case\ndefault</xmp>",
