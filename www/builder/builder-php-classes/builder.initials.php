...
{	
	...
	private $errors = array(
		...
		'unknownMouseEvent' => 'Initial параметр <b>events</b> в классе {??} содержит неподдерживаемое событие {??}<xmp>initial {?} = {?}</xmp>Список поддерживаемых событий:<xmp>{?}</xmp>',
		'emptyMouseEvents' => 'Initial параметр <b>events</b> в классе {??} содержит поле {??}, которое не содержит элементов<xmp>initial {?} = {?}</xmp><b>Параметр должен иметь вид:</b> {?}'
	); 
