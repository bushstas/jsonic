...
var defineTargetClasses=function(){targetClasses=[];defineCheckboxClass();if(checkboxClass)targetClasses.push(checkboxClass);labelClass=__O.get(currentOptions,'labelClass');if(isString(labelClass))targetClasses.push(labelClass);else if(isArray(labelClass))targetClasses=targetClasses.concat(labelClass)};
var defineCheckboxClass=function(options){checkboxClass=__O.get(options||currentOptions,'checkboxClass',defaultCheckboxClass)};
...
var defineCheckedClass=function(){currentCheckedClass=__O.get(currentOptions,'checkboxCheckedClass',defaultCheckboxCheckedClass)};
...
var isIntValue=function(){return __O.has(currentOptions,'intValue',true)};
