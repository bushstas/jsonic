__G.set((c=function(){
if(!this||this==window){
var extendOptions=function(index,opts){__O.merge(this.options[index],opts)};
...
this.subscribers=[];this.options=[];var eh={{GLOBAL}}.get('EventHandler');this.eventHandler=new eh();
})(),'MouseHandler');