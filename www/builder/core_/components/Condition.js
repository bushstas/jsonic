...
if(!this||this==window){
var createLevel=function(isUpdating){var l=_G_.get('Level');this.level=new l(this.parentLevel.getComponent());var nextSiblingChild=isUpdating?_C_.getNextSiblingChild.call(this):null;this.level.render(getChildren.call(this),this.parentElement,this.parentLevel,nextSiblingChild)};
...
p.dispose=function(){_C_.disposeLinks.call(this);disposeLevel.call(this);this.parentElement=null;this.parentLevel=null;this.params=null};
return c;
}
