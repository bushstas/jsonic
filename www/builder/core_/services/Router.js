_G_.set(function(){
var properRoutes={},routes=__ROUTES,isHashRouter=!!__HASHROUTER,defaultRoute=__DEFAULTROUTE,indexRoute=__INDEXROUTE,errorRoutes=__ERRORROUTES,handler,bodyElement,menues,currentRoute,subscribers,pathParts;
