...
this.get=function(key,callbackOrPropName,thisObj){var item=__O.get(items,key);if(item)return item;callbacks=callbacks||[];callbacks.push([callbackOrPropName,thisObj,key])};
