...
{	
	...
	private $errors = array(
		...
		'incorrectListenersKey' => "Initial параметр {??} в классе {??} имеет недопустимое поле {??} со значением {??}<br>Список допустимых полей:<xmp>local\nglobal</xmp><b>Параметр должен иметь вид:</b> {?}",
		'incorrectListenersObj' => "Initial параметр {??} в классе {??} имеет поле {??} со значением {??}<br>Данное поле должно быть ассоциативным массивом<br><br><b>Параметр должен иметь вид:</b> {?}"
	);
