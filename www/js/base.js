...
Main.prototype.getTemplateMain = function(p, args) {
	return[{'c':{'c':{'c':[{'c':{'c':[{'c':__[15],'t':0},{'cmp':UserInfo}],'t':0},'t':6,'p':{'c':'app-mainpage-left-column'}},{'t':6,'p':{'c':'app-mainpage-content-column'}}],'t':5},'t':2,'p':{'c':'app-mainpage-table','cp':'0px','cs':'0px'}},'t':0,'p':{'c':'view-content main-view-content','sc':1}}]
};
...
SearchForm.prototype.getTemplateMain = function(p, args) {
	return[{'c':[{'c':args.title,'t':0,'p':{'c':'app-search-form-title'}},{'t':0,'e':[0,this.toggleExpand.bind(this)],'p':{'c':'app-search-form-close'}},{'cmp':TenderSearchForm}],'t':0,'p':{'c':'app-search-form','sc':1}}]
};
...
SearchFormFilterMenu.prototype.getInitials = function() {
	return {
		...
		'helpers':[{'helper': CheckboxHandler,'handler': this.onCheckboxChange,'options': {'intValue': true,'checkboxClass': 'app-ui-checkbox','checkboxCheckedClass': 'checked','labelClass': null}}]
	};
};
...
UserInfo.prototype.onLoaded = function(data) {
	if (!User.hasFullAccess()) {
		data['prolongButtonText'] = __[26];
	} else if (data['needToProlong']) {
		data['prolongButtonText'] = __[27];
	}
	this.set(data);
};
...
UserInfo.prototype.getTemplateMain = function(p, args) {
	return[{'c':[{'c':[{'c':[__[16],':'],'t':6},{'c':{'pr':'userName','p':p('userName')},'t':6}],'t':5},{'c':[{'c':[__[17],':'],'t':6},{'c':{'pr':'companyName','p':p('companyName')},'t':6}],'t':5},{'c':[{'c':[__[18],':'],'t':6},{'c':{'pr':'userEmail','p':p('userEmail')},'t':6}],'t':5},{'c':[{'c':[__[19],':'],'t':6},{'c':{'pr':'typeAccess','p':p('typeAccess')},'t':6,'p':{'c':' bold'}}],'t':5},{'c':[{'c':[__[20],':'],'t':6},{'c':{'pr':'beginAccessDate','p':p('beginAccessDate')},'t':6}],'t':5},{'c':[{'c':[__[21],':'],'t':6},{'c':{'pr':'endAccessDate','p':p('endAccessDate')},'t':6,'p':{'c':function(){return[p('needToProlong')?'red':'']}},'n':{'c':'needToProlong'}}],'t':5}],'t':2,'p':{'c':'app-mainpage-user-info','cp':'0px','cs':'0px','sc':1}},{'c':function(){return[{'c':{'pr':'prolongButtonText','p':p('prolongButtonText')},'t':12,'p':{'h':__[25],'tr':'_blank','c':'access standart-button red-button'}}]},'p':['prolongButtonText'],'i':function(){return(p('prolongButtonText'))}},{'c':__[23],'t':12,'p':{'h':__[22],'tr':'_blank','c':'tariffs standart-button white-button'}},{'c':__[24],'t':0,'p':{'c':'mainpage-manager-title bold'}},{'c':[{'c':{'pr':'managerName','p':p('managerName')},'t':0,'p':{'c':'mainpage-manager-name'}},{'c':[{'c':[' ',{'c':__[28],'t':0,'p':{'c':'mainpage-manager-large-phone'}},{'c':__[29],'t':0,'p':{'c':'mainpage-manager-free'}}],'t':0,'p':{'c':'mainpage-free-call'}},{'pr':'managerPhone','p':p('managerPhone')},__T[1],{'c':__[30],'t':51}],'t':0,'p':{'c':'mainpage-manager-phone'}},{'c':{'pr':'managerEmail','p':p('managerEmail')},'t':0,'p':{'c':'mainpage-manager-email'}}],'t':0,'p':{'c':'mainpage-manager-info'}},{'c':__[31],'t':0,'e':[0,this.onOrderCallButtonClick.bind(this)],'p':{'c':'standart-button green-button'}}]
};
...
OrderCall.prototype.getTemplateMain = function(p, args) {
...
AuthForm.prototype.getInitials = function() {
	return {
		'options':{'action': 'api/user/login.php','method': 'POST','ajax': true,'container': 'app-authform-inputs','controls': [{'cmpid': 'login','type': 'text','name': 'login','placeholder': __[9],'caption': __[10]},{'cmpid': 'password','type': 'password','name': 'password','placeholder': __[11],'caption': __[12]}],'submit': {'value': __[13],'class': 'app-submit'}}
	};
};
...
Input.prototype.getTemplateMain = function(p, args) {
	return[{'c':[{'c':function(){return[{'c':{'pr':'caption','p':p('caption')},'t':0,'p':{'c':'app-input-caption'}}]},'p':['caption'],'i':function(){return(p('caption'))}},{'t':14,'e':[18,this.onChange.bind(this)],'p':{'tp':function(){return[p('type')]},'n':function(){return[p('name')]},'c':function(){return[p('class')]},'p':function(){return[p('placeholder')]},'v':function(){return[p('value')]}},'n':{'tp':'type','n':'name','c':'class','p':'placeholder','v':'value'}}],'t':0,'p':{'c':'app-input-container','sc':1}}]
};
